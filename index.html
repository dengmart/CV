            ...
            <div class="row g-5">
                <div class="col-lg-4 sticky-lg-top vh-100">
                    <div class="d-flex flex-column h-100 text-center overflow-auto shadow">
                        ...
                        <h1 class="text-primary mt-2">Deng Yak</h1>
                        <div class="mb-4" style="height: 22px;">
                            <h4 class="typed-text-output d-inline-block text-light"></h4>
                            <div class="typed-text d-none">Web Designer, Network Engineer, Web Developer, Front End Developer, Apps Designer, Apps Developer, Graphic Designer</div>
                        </div>
                ...
                <div class="col-lg-8">
                    ...
                    <section class="py-5 border-bottom wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p>Deng Martin is a versatile professional with a unique blend of skills as both a system administrator and a graphic designer. With his technical expertise and creative flair, Deng bridges the gap between functionality and design, making him a valuable asset in any organization.

As a system administrator, Deng has a strong foundation in managing and maintaining IT infrastructure. He’s responsible for ensuring the smooth operation of computer systems, networks, and servers. His role involves troubleshooting, system updates, and providing technical support to users. Deng’s technical knowledge extends to managing software, hardware, and security systems, allowing him to solve complex issues with efficiency and precision. His attention to detail and methodical approach ensures the stability and security of any IT environment he oversees.</p>
                        <div class="row mb-4">
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Name:</span> Deng Martin Yak Guill
                            </div>
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Birthday:</span> 16 June 1996
                            </div>
                            <div class="col-sm-6 py-1">
                            ...
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Phone:</span> +211988897972
                            </div>
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Email:</span> dengguill@proton.me 
                            </div>
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Address:</span> Jebel suk, Juba, South Sudan
                            </div>
                            <div class="col-sm-6 py-1">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4 col-lg-6 col-xl-4">
                                <div class="d-flex bg-secondary p-4">
                                    <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">133</h1>
                                    <div class="ps-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="skill mb-4">
                                    ...
                                    <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                        <p class="mb-2">Adobe PS and A.I</p>
                                        <p class="mb-2">95%</p>
                                    </div>
                                    <div class="progress">
                    ...
                    <section class="py-5 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="border-start border-2 border-light pt-2 ps-5">
                            <div class="position-relative mb-4">
                                ...
                                <h5 class="mb-1">System Admin</h5>
                                <p class="mb-2">Nile drilling and Services Co. ltd. | <small>Oct 2022 - April 2023</small></p>
                                <p>I use to give desktop help to employees, monitor company network and database, also managed the company website and the social media handles, and was also the graphic designer to th PR team.</p>
                            </div>
                            <div class="position-relative mb-4">
                                <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                                <h5 class="mb-1">Technician and Sys Admin</h5>
                                <p class="mb-2">Primatech Co. ltd. | <small>May 2023 - March 2024</small></p>
                                <p>I built and manged the store database, also installed and managed the company network and sold the IT equipments such as switches, routers, network cables etc.</p>
                            </div>
                            <div class="position-relative mb-4">
                                <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                                <h5 class="mb-1">Database Admin</h5>
                                <p class="mb-2">Grace Clinics | <small>2019 - ...</small></p>
                                <p>I created the clinic POS system and manage upto date.</p>
                            </div>
                            <div class="position-relative mb-4">
                                <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                                <h5 class="mb-1">Graphic Designer</h5>
                                <p class="mb-2">Service Center | <small>May 2024 - Upto date</small></p>
                                <p>Worked as a graphic designer.</p>
                            </div>
                        </div>
                    </section>
                    <!-- Expericence End -->
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="service-item">
                                    ...
                                    <p class="mb-0">"Good web design is not just about looks—it's about function, clarity, and experience."</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="service-item">
                                    ...
                                    <p class="mb-0">"Great apps aren’t just coded—they are crafted with vision, refined with feedback, and powered by innovation."</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="service-item">
                                    ...
                                    <p class="mb-0">"SEO: Where visibility meets strategy—optimize, rank, and grow!"</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="service-item">
                                    ...
                                    <p class="mb-0">"Digital marketing is not about being seen—it's about being remembered."</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="wow fadeIn" data-wow-delay="0.1s">
                        <div class="bg-secondary text-light text-center p-5">
                            <div class="d-flex justify-content-center mb-4">
                                ...
                                <a class="btn btn-dark btn-square mx-1" href="https://www.facebook.com/deng.yak.9?mibextid=JRoKGi"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-dark btn-square mx-1" href="https://www.linkedin.com/in/deng-guil-jr-a4b379293?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"><i class="fab fa-linkedin-in"></i></a>
                                <a class="btn btn-dark btn-square mx-1" href="https://www.instagram.com/deng_yak"><i class="fab fa-instagram"></i></a>
                            </div>
							...
							<p class="m-0">&copy; All Rights Reserved. Designed by <a href="https://htmlcodex.com">Sematech</a></p>
                        </div>
                    </section>
                    <!-- Footer End -->
                </div>
